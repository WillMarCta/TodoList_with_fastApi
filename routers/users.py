...
async def update_user(user_id: str, user_update: UserUpdate, current: UserOut = Depends(current_user)):
    ...
    # Encriptar nueva contraseña si se incluye
    ...
    if not updated_user:
        raise HTTPException(status_code=404, detail="Usuario actualizado pero no encontrado")
